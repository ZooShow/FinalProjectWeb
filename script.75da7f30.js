...
},{"process":"node_modules/process/browser.js"}],"script.js":[function(require,module,exports) {
...
var start = function start() {
  ...
  if (sessionStorage.isStart == "true") {
    $("body").addClass("back");
    var aMas = document.querySelectorAll("a");

    var _iterator = _createForOfIteratorHelper(aMas),
        _step;
    ...
    var liMas = document.querySelectorAll("li");

    var _iterator2 = _createForOfIteratorHelper(liMas),
        _step2;
...
var saveToSessionStarage = function saveToSessionStarage() {
  sessionStorage.setItem("isStart", true);
};

var l5 = function l5() {
  $(".lesson5").fadeToggle(TIME, function () {
    $(".i").fadeToggle(TIME, function () {
...
var l4 = function l4() {
  $(".lesson4").fadeToggle(TIME, function () {
    $(".F").addClass("submenu");
    $(".F").fadeToggle(TIME, function () {
      l5();
    });
  });
};
...
var l3 = function l3() {
  $(".m").addClass("menu");
  $(".lesson3").fadeToggle(TIME, function () {
    $(".mes").fadeToggle(TIME, l4);
  });
};

var l2 = function l2() {
  $(".lesson2").fadeToggle(TIME, function () {
    var aMas = document.querySelectorAll("a");

    var _iterator3 = _createForOfIteratorHelper(aMas),
        _step3;
    ...
    var _iterator4 = _createForOfIteratorHelper(liMas),
        _step4;
...
var l1 = function l1() {
  $(".lesson1").fadeToggle(TIME, function () {
