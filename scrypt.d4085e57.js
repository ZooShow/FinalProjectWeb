...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/SubSites/whaclAMole/src/scrypt.js":[function(require,module,exports) {
...
var burrowUp = function burrowUp() {
  var old = document.querySelector('.burrowUp');
  var number = Math.floor(Math.random() * 9 + 1);
  var newNode = document.querySelector(".g" + number);
  old.classList.remove('burrowUp');
  newNode.classList.add('burrowUp');
};

var play = document.getElementById('play');
var rePlay = document.getElementById('retry');
var i = 0;
var time = 3;
...
function startGame() {
  ...
  var clicks = document.querySelectorAll('.burrow-hole');
  var score = document.querySelector('.score');
  score.textContent = 0;

  var _iterator = _createForOfIteratorHelper(clicks),
      _step;

  try {
    var _loop = function _loop() {
      var click = _step.value;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/SubSites/whaclAMole/src/scrypt.js"], null)
//# sourceMappingURL=/scrypt.d4085e57.js.map